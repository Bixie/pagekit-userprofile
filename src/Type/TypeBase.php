...
class TypeBase implements TypeInterface, \ArrayAccess, \JsonSerializable {
	...
	public function registerScripts ($scripts) {
		$script = $this->type['resource'] . '/userprofile-' . $this->id . '.js';
		$scripts->register('userprofile-' . $this->id, $script, array_merge(['~userprofile-profilefields'], $this->type['dependancies']));
	}
